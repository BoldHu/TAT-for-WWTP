...
def TL_experiment():
    ...
    train_source_feature_name_list = ['X_kla240.mat', 'X_kla240.mat', 
                                      'X_kla360.mat', 'X_kla360.mat', 
                                      'X_kla480.mat', 'X_kla480.mat']
    train_source_label_name_list = ['EQvec_kla240.mat', 'EQvec_kla240.mat', 
                                    'EQvec_kla360.mat', 'EQvec_kla360.mat', 
                                    'EQvec_kla480.mat', 'EQvec_kla480.mat']
    train_target_feature_name_list = ['X_mu0.7.mat', 'X_mu0.9.mat',
                                      'X_mu0.7.mat', 'X_mu0.9.mat',
                                      'X_mu0.7.mat', 'X_mu0.9.mat']
    train_target_label_name_list = ['EQvec_mu0.7.mat', 'EQvec_mu0.9.mat',
                                    'EQvec_mu0.7.mat', 'EQvec_mu0.9.mat',
                                    'EQvec_mu0.7.mat', 'EQvec_mu0.9.mat']
    
    # train_source_feature_name_list = ['test_X_kla240.mat', 'test_X_kla240.mat', 
    #                                  'test_X_kla360.mat', 'test_X_kla360.mat', 
    #                                  'test_X_kla480.mat', 'test_X_kla480.mat']
    # train_source_label_name_list = ['test_EQvec_kla240.mat', 'test_EQvec_kla240.mat', 
    #                                'test_EQvec_kla360.mat', 'test_EQvec_kla360.mat', 
    #                                'test_EQvec_kla480.mat', 'test_EQvec_kla480.mat']
    # train_target_feature_name_list = ['test_X_mu0.7.mat', 'test_X_mu0.9.mat',
    #                                  'test_X_mu0.7.mat', 'test_X_mu0.9.mat',
    #                                  'test_X_mu0.7.mat', 'test_X_mu0.9.mat']
    # train_target_label_name_list = ['test_EQvec_mu0.7.mat', 'test_EQvec_mu0.9.mat',
