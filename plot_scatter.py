...
def plot_scatter(source_feature, source_label, target_feature, target_label, task_number, source_kla, source_mu, target_kla, target_mu):
    ...
    my_net = torch.load(os.path.join('models', 'DSN4_model_' + source_dataset_name + '_' + target_dataset_name + '.pth'))
    ...
    if not os.path.exists('figures/DSN4'):
        os.makedirs('figures/DSN4')
